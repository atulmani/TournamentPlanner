...
{
    public partial class TP_Match_Upcoming : System.Web.UI.Page
    {
        ...
        private void PopulateMatches(string strDate)
        {
            try
            {
                ...
                List<TPMatch> lstObj = (new TPDAL_Match()).GetMatchesBySportANDTournamentUmpire(strSportCode, strTournamentCode, strEventCode, strDate);
        ...
        protected void dgMatchList_RowDataBound(object sender, DataGridItemEventArgs e)
        {
            ...
            if (e.Item.Cells[8].Text.Equals("Second"))
            {
                //e.Item.Cells[3].BackColor = System.Drawing.Color.Blue;
