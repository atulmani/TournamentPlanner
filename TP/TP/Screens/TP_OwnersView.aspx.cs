...
namespace TournamentPlanner
{
	...
	/// </summary>
	public partial class TP_OwnersView : System.Web.UI.Page
	{	
...
//					PopulateOwnerDashboard(strTournamentCode);
        ...
        private bool CheckUserAuthentication (String strTournamentCode, String strUserCode, String strOTP)
        {
        	bool bIsUserExists = true;
        	//String strUserType = "OWNER";
        	...
        	try
            {
        		bIsUserExists = true; //(new TPDAL_UserAuthenticationAuthorization()).CheckUserAuthentication (strTournamentCode, strUserCode, strOTP, strUserType);
        	}
        	catch (Exception ex)
        	{
				pnlOwnerLogin.Visible = true;
        ...
        protected void btnOwnerLogin_Click(object sender, EventArgs e)
        {
        	...
        	{	
	        	...
	        	bool bIsUserExists = CheckUserAuthentication (strTournamentCode, strUserCode, strOTP);
